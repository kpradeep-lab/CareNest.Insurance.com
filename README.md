...
<head>
  ...
  <title>Care Nest Insurance</title>
  <meta name="description" content="Care Nest Insurance — Affordable, reliable health and life insurance plans with easy claims and 24/7 support.">
  <style>
...
<body>
    ...
    <section id="contact" style="margin-top:18px">
      ...
      <div class="contact" style="margin-top:12px">
        ...
        <div style="padding:12px;background:#f8faf8;border-radius:10px">
          <h4>Office</h4>
          <p class="muted">Care Nest Insurance<br>123 Wellness Avenue<br>Bengaluru, India</p>
  ...
  <footer>
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap">
      <div>© <strong>Care Nest Insurance</strong> — All rights reserved</div>
